...
const ApplySection = ({ intl }) => (
  <section className={styles.applySection}>
    <div className={styles.innerContainer}>
      ...
      <div className={styles.subTitle}>{intl.formatMessage({ id: "HOWTO.APPLY.subTitle" })}</div>
      <div className={styles.content}>{intl.formatMessage({ id: "HOWTO.APPLY.content" })}</div>
