export default {
  ...
  "MAIN.FIRST.subTitle": `SUALAB believes that artificial intelligence can contribute to the world by automating\ntasks that have required human effort.`,
  ...
  "SUAKIT.FIRST.cardContent_1": `Shapes and areas of defects are inspected accurately through image analysis.\n\nThe solution can detect various defects on a range of surfaces, including solar panels and camera lenses, and classify those defects by type.`,
  "SUAKIT.FIRST.cardContent_2": `Images are interpreted and classified according to the class definition.\n\nThe solution can be used to acquire product /defect images from surfaces that can have various defect types, such as displays and films. Then the solution can be used to classify the images. `,
  "SUAKIT.FIRST.cardContent_3": `Various objects in a single image are classified according to the features / classes that were trained.\n\nYou can detect each object by analyzing a single picture taken of several objects in the manufacturing line of machines / parts.`,
  ...
  "SUPPORT.status": `Professional Title`,
  "SUPPORT.email": `Email`,
  "SUPPORT.country": `Country`,
  "SUPPORT.reason": `Reason for Inquiry`,
  "SUPPORT.reason.item_0": `Please select the reason for your inquiry.`,
  "SUPPORT.reason.item_1": `Product Inquiry`,
  "SUPPORT.reason.item_2": `Partnership`,
  "SUPPORT.reason.item_3": `Etc.`,
  "SUPPORT.info": `For any questions arising from product usage,\nplease email us at <a href="mailto:support@sualab.com">support@sualab.com</a> instead of submitting an inquiry on this page.`,
  "SUPPORT.vision": `Have Vision Inspection Equipment Yes/No`,
  "SUPPORT.vision.yes": `Yes`,
  "SUPPORT.vision.no": `No`,
  "SUPPORT.vision.dontknow": `Don't know`,
  "SUPPORT.industry": `Industry`,
  "SUPPORT.productType": `Product Type`,
  "SUPPORT.faultType": `Defect Type`,
  "SUPPORT.numOfLine": `Number of Production Lines`,
  "SUPPORT.path": `How did you hear about us?`,
  "SUPPORT.path.item_info": `Choose the route you heard`,
  "SUPPORT.path.item_0": `Exhibition/Seminar`,
  "SUPPORT.path.item_1": `Introduction of others.`,
  "SUPPORT.path.item_2": `Media(Article/Broadcast or etc.)`,
  "SUPPORT.path.item_3": `Search(Portal/Homepage or etc.) `,
  "SUPPORT.path.item_4": `Others`,
  "SUPPORT.supportContent": `Inquiry`,
  "SUPPORT.termsAgree": `I accept the Terms of Service, Personal Information Collection and Use Agreement (Required)`,
  "SUPPORT.adAgree": `I agree to accepting advertising information (Optional)`,
  "SUPPORT.modalBtn": `Details`,
